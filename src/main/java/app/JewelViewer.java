...
public class JewelViewer  extends Application{
	 ...
	 private static final String MESH_FILENAME = "/home/ariel/workspace/testJava/bin/testJava/skorupa7.stl";
			  ...
			  private Group buildScene() {
			    ...
			    System.out.println("lenght" + meshViews.length);
...
//			      meshViews[i].setScaleZ(MODEL_SCALE_FACTOR);
			...
			public void start(Stage primaryStage) throws Exception {
			    ...
			    System.out.println("Start metod");
